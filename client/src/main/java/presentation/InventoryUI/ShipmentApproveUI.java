...
public class ShipmentApproveUI extends JPanel {
	...
	private List<ShipmentVO> list;

	public ShipmentApproveUI() throws RemoteException {
	...
	private Vector<String> toVector(ShipmentVO vo) {
