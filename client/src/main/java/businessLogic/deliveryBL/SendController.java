...
public class SendController implements SendBLService {
	...
	public double getFare(String departure, String destination,
			PackType packType, Express transferType, double weight,
			double length, double width, double height) throws RemoteException,
			ClientInitException {
		return sendBL.getPrice(departure, destination, packType, transferType,
