...
public class ArrivalBL {
	...
	public String updateLogisticsFromB(List<String> goodsID,
			String institutionName) throws RemoteException {
	...
	public List<String> getIDListFromEntruck(String entruckID)
	...
	public List<String> getIDListFromTransfer(String transferID)
			throws ClientInitException, RemoteException {
