...
public class PaymentBL {
	...
	public double getSalaryTotal() throws RemoteException {
		...
		result = delivery * salaryBL.getSalaryByWork("快递员") + businessHall
				* salaryBL.getSalaryByWork("营业厅业务人员") + intermidate
				* salaryBL.getSalaryByWork("中转中心业务人员") + inventory
				* salaryBL.getSalaryByWork("中转中心仓库管理员") + financeH
				* salaryBL.getSalaryByWork("财务人员（高）") + financeL
				* salaryBL.getSalaryByWork("财务人员（低）") + mananger
				* salaryBL.getSalaryByWork("总经理");
